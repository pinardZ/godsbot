...
# 4. 编辑实例 - 编辑网络接口 - 新增外部 ip 地址 - 保存自动重启实例 - 完成 ip 更改


def main():
    compute_client = compute_v1.InstancesClient.from_service_account_json('still-catalyst-336215-26dbf969c522.json')
    instances_listPager = compute_client.list(project="still-catalyst-336215", zone="us-west4-b")
    ...
    # print(instance.name)
    # compute_client.list(project="still-catalyst-336215", zone="us-west1-b", instances=instance.)
